...
export default function PomodoroComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-purple-800 dark:bg-gray-900">
      {/* Center the Pomodoro timer card within the screen */}
      <Card className="w-full max-w-md p-6 bg-red-100 dark:bg-gray-800 shadow-lg rounded-lg">
        <div className="flex flex-col items-center justify-center gap-6">
          <h1 className="text-4xl font-bold text-purple-900">Pomodoro Timer</h1>
          <p className="text-purple-900 font-bold">A timer for the Pomodoro Technique.</p>
          <div className="flex flex-col items-center gap-4">
            {/* Display current session (work or break) */}
            <div className="text-2xl font-medium">
              <span
                className={`text-purple-900 font-semibold text-${
            ...
            <div className="text-8xl font-bold text-purple-900">
              {formatTime(state.currentTime)}
            </div>
          </div>
          <div className="flex items-center gap-4">
            {/* Buttons to change duration, start/pause, and reset timer */}
            <Button className=" text-red-100 bg-purple-900 hover:text-purple-900 hover:bg-red-300"
              variant="outline"
              size="icon"
            ...
            <Button className=" text-red-100 bg-purple-900 hover:text-purple-900 hover:bg-red-300" variant="outline" size="icon" onClick={handleStartPause}>
            ...
            <Button className=" text-red-100 bg-purple-900 hover:text-purple-900 hover:bg-red-300" variant="outline" size="icon" onClick={handleReset}>
          ...
          <div className="p-2">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button variant="default" className="text-red-100 bg-purple-900 hover:text-purple-900 hover:bg-red-300">What is Pomodoro Technique?</Button>
              </AlertDialogTrigger>
